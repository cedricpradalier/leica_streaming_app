...
TCPTSInterface::TCPTSInterface(rclcpp::Node * node, std::function<void(const TSMessage &)> locationCallback)
	: TSInterface(node,locationCallback), socket_(new boost::asio::ip::tcp::socket(*io_context_))
	{}
